...
const MODEL_CATALOG = [
  {
    ...
    models: [
      ...
      { name: "Tail Immersion Test", status: "live", href: "models/tail-immersion.html" },
      { name: "Acetic Acid-Induced Writhing", status: "live", href: "models/writhing.html" },
      { name: "Formalin-Induced Paw Licking", status: "live", href: "models/formalin.html" },
      { name: "Randall–Selitto Test", status: "live", href: "models/randall-selitto.html" },
      { name: "Forced Swim Test", status: "live", href: "models/fst.html" },
      { name: "Tail Suspension Test", status: "live", href: "models/tail-suspension.html" },
      { name: "Learned Helplessness", status: "live", href: "models/learned-helplessness.html" },
      { name: "Elevated Plus Maze", status: "live", href: "models/epm.html" },
      { name: "Elevated Zero Maze", status: "live", href: "models/zero-maze.html" },
      { name: "Open Field Test", status: "live", href: "models/open-field.html" },
      { name: "Light–Dark Box", status: "live", href: "models/light-dark-box.html" },
      { name: "Hole Board Test", status: "live", href: "models/hole-board.html" },
      { name: "Apomorphine-Induced Climbing", status: "live", href: "models/apomorphine-climbing.html" },
      { name: "Amphetamine-Induced Stereotypy", status: "live", href: "models/amphetamine-stereotypy.html" },
      { name: "MK-801-Induced Hyperlocomotion", status: "live", href: "models/mk801-hyperlocomotion.html" },
      { name: "Catalepsy Test", status: "live", href: "models/catalepsy.html" },
      { name: "Maximal Electroshock Seizure (MES)", status: "live", href: "models/mes.html" },
      { name: "PTZ-Induced Seizures", status: "live", href: "models/ptz-seizures.html" },
      { name: "Picrotoxin-Induced Seizures", status: "live", href: "models/picrotoxin-seizures.html" },
      { name: "Isoniazid-Induced Seizures", status: "live", href: "models/isoniazid-seizures.html" },
      { name: "Pentobarbitone-Induced Sleeping Time", status: "live", href: "models/pentobarbitone-sleep.html" },
      { name: "Rotarod Test", status: "live", href: "models/rotarod.html" },
      { name: "Morris Water Maze", status: "live", href: "models/morris-water-maze.html" },
      { name: "Y-Maze", status: "live", href: "models/y-maze.html" },
      { name: "Novel Object Recognition", status: "live", href: "models/novel-object-recognition.html" },
      { name: "Passive Avoidance", status: "live", href: "models/passive-avoidance.html" },
      { name: "6-OHDA Model", status: "live", href: "models/6ohda-model.html" },
      { name: "Rotenone Model", status: "live", href: "models/rotenone-model.html" },
      { name: "MPTP Model", status: "live", href: "models/mptp-model.html" },
      { name: "Haloperidol-Induced Catalepsy", status: "live", href: "models/haloperidol-catalepsy.html" },
      { name: "Scopolamine-Induced Amnesia", status: "live", href: "models/scopolamine-amnesia.html" },
      { name: "Aβ-Induced Model", status: "live", href: "models/abeta-model.html" },
      { name: "AlCl₃ Model", status: "live", href: "models/alcl3-model.html" },
      { name: "Beam Walking", status: "live", href: "models/beam-walking.html" },
      { name: "Footprint Analysis", status: "live", href: "models/footprint-analysis.html" },
